          ...
          <Col size={12}>
            <div>
              ...
              <p>
                ...
                From rare vinyl and tapes to uniquely categorized albums, Top Ten Records creates an eclectic experience for music lovers.
              </p>
              <p>
                Its retro listening area, paired with its Texas Music Archive, provides a bridge between the past and present, preserving the rich 
                ...
                <Tab.Content id="slideInUp" className="animate__animated animate__slideInUp">
                  ...
                  <Tab.Pane eventKey="third">
                    ...
                    <div className="proj-imgbx" style={{ maxWidth: "250px", margin: "0 auto" }}>
                      <Image
                        src="/assets/img/topten/topten_map.png"
                      ...
                      <div className="proj-txtx">
                        ...
                        <span>Find them near the heart of Oak Cliff.</span>
                      </div>
                    </div>
                  </Tab.Pane>
                </Tab.Content>
